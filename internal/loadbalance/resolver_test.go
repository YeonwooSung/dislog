...
import (
	...
	"github.com/YeonwooSung/dislog/internal/config"
	"github.com/YeonwooSung/dislog/internal/loadbalance"
	"github.com/YeonwooSung/dislog/internal/server"
)
...
func TestResolver(t *testing.T) {
	...
	urlStr := fmt.Sprintf("localhost:%d", l.Addr().(*net.TCPAddr).Port)
